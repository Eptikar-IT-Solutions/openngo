User.create(name: 'admin', full_name: 'Administrator', email: 'info@eptikar.com', password: '123', password_confirmation: '123', active: true)
...
role1 = Role.create(name: 'Program Coordinator')

role2 = Role.create(name: 'Treasury Secretary')

member1 = Member.create(name: 'Ahmed Ali', gender: 0, email: 'ahmed.ali87@hotmail.com', mobile: '0024912800284', joined_at: '2013-07-10' ,profession_id: profession1.id, education: 'Master degree in zoology', bio: 'Zoologists who worked for a room to read organization for 6 years', active: true, branch_id: branch.id, role_id: role1.id)

member2 = Member.create(name: 'Osama Abdain', gender: 0, email: 'osama.abdeen@hotmail.com', mobile: '0024912900774', joined_at: '2013-08-10' ,profession_id: profession2.id, education: 'Avid enviroment activist who worked on in this area in many Kenya and South Africa', active: true, branch_id: branch.id, role_id: role2.id)
