...
####################Member################################################
rails g scaffold_controller Member name:string gender:integer joined_at:date email:string mobile:string address:string profession:integer education:integer branch_id:integer role_id:integer  bio:text active:boolean -f
...
####################ProjectMember#########################################
rails g scaffold_controller ProjectMember project_id:integer member_id:integer role_id:integer -f
...
####################ActivityMember##########################################
rails g scaffold_controller ActivityMember activity_id:integer member_id:integer role_id:integer -f
