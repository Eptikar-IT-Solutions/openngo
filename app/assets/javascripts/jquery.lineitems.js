...
function newLine(){
  ...
  $('.line-items').append('<tr class="line-item" id="line-'+ line +'">\
    ...
    <td><input class="form-control" name="' + lines_parent_type + '[lines_attributes][' + line + '][quantity]" type="number"></td>\
    <td><input class="form-control product-price" name="' + lines_parent_type + '[lines_attributes][' + line + '][price]" type="number"></td>\
    <td class="hidden-print">\
      <a class="btn btn-default add-attribute" href="javascript:newLine()" rel="nofollow" style="visibility:hidden;"><span class="glyphicon glyphicon-plus"></span></a>\
